...
<div style="padding: 10px 0; border-top: 0px solid #8E8E8E; border-bottom: 1px solid #8E8E8E; margin-bottom: 15px;"><div style="height: 30px; padding: 7px;">
        <a href="http://www.altasib.ru?utm_source=mod_feedback" target="_blank"><img src="/bitrix/images/altasib.feedback/altasib.png" style="float: left; margin-right: 15px;" border="0" /></a>
