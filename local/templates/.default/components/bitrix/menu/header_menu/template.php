...
<?php
    ...
    $fields = [
        ...
        'GROUP_ID' => [2], // добавляем пользователя в группу "зарегистрированные пользователи"
    ];
    ...
    <?php else: ?>
        <div id="authModal" class="iHide">
            Ошибка регистрации пользователя: <?=$user->LAST_ERROR;?>
        </div>
    <?php endif; ?>
<?php endif; ?>

    <div id="authModal" class="iHide">
        <?$APPLICATION->IncludeComponent("bitrix:system.auth.form", "auth_top", Array(
                    ...
                    <form id="regForm" method="POST">
                        <div class="labelOnTop">
                            <div class="row">
                                ...
                                <input type="text" name="USER_LOGIN" value="" required="error"/>
                            </div>
                            <div class="row">
                                <label>E-mail</label>
                                <input type="text" name="USER_EMAIL" value="" required="error"/>
                            </div>
                            <div class="row">
                                <label>Пароль</label>
                                <input type="password" name="USER_PASSWORD" value=""/>
                                <span class="togglePassView"> <img src="/local/templates/dell/img/icons/eye.svg" class="passVisible" alt=""> <img src="/local/templates/dell/img/icons/eyeClosed.svg" class="passHidden" alt=""> </span>
                            </div>
                        </div>

                        <button class="sForm" type="submit" form_id="authForm"> <span class="iconBlueButton">→</span>
                    ...
                    <div class="forgotPassForm">
                        <form>
                            ...
                            <div class="labelOnTop js-toggleForm">
                                <div class="row">
                                    <label>E-mail*</label> <input type="text" name="" required="error">
                                </div>
                                <div class="row iHide">
                                    <label>Номер телефона*</label> <input type="text" name="" required="error">
                                </div>
                            </div>
                            <div class="capchaWrap">
                                <img src="/local/templates/dell/img/capcha.png" alt="">
                            </div>
                            <div class="textCenter">
            ...
            <div class="left">
                ...
                <nav class="headerMenu">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= $item['LINK']; ?>" class="active"><?= $item['TEXT']; ?></a></li>
                        <?php else: ?>
                        ...
                        <li class="mobHide posRelative">
                            <a href="#" class="iconSearch js-openSearch">
<!--                                <img class="iconSearch js-openSearch" src="--><?//=SITE_TEMPLATE_PATH?><!--/img/icons/search.svg" alt="">-->
                            </a>
                            <div class="searchBox">
            ...
            <div class="right">
                <div class="userActions">
                    <ul>
                        ...
                        <li>
                            <a href="/personal/" class="js-openAuthModal">
